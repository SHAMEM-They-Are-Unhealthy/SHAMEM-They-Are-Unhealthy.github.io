import"./NavBar-8kjRtyNB.js";function c(e,s){return s.topScore-e.topScore}const r=document.querySelector(".center");$(document).ready(function(){$.get("https://shamem.glitch.me/get_highscores").done(function(e,s){var a=JSON.parse(e);let t=a.sort(c);o(t),d()})});function o(e){let s=e.map((a,t)=>`<article class="item">
