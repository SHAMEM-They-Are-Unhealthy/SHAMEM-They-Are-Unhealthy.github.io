...
<div style="height: 55px"></div>`}}customElements.define("nav-bar",o);document.addEventListener("DOMContentLoaded",function(){const s=document.querySelector(".hamburger"),a=document.querySelector(".nav-menu"),l=document.querySelectorAll(".nav-link");s.addEventListener("click",n),l.forEach(t=>t.addEventListener("click",e));function n(){s.classList.toggle("active"),a.classList.toggle("active")}function e(){s.classList.remove("active"),a.classList.remove("active")}});
