import"./NavBar-fI6Nk3Gk.js";const c=r=>{var a;return((a=document.cookie.match("(^|;)\\s*"+r+"\\s*=\\s*([^;]+)"))==null?void 0:a.pop())||""};var t;$(document).ready(function(){c("session-id")!=null?$.get("https://shamem.glitch.me/login_test",{sessionID:c("session-id")}).done(function(r,a){document.cookie="session-id="+r+"; path=/",$.get("https://shamem.glitch.me/get_results",{sessionID:c("session-id")}).done(function(i,d){var l=JSON.parse(i);document.cookie="session-id="+l.uuid+"; path=/",t=l.data;const u=document.querySelector(".center");function w(o){let s=o.map((e,n)=>`<div class="summary-item">
