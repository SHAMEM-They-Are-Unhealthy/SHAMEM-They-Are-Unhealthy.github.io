import"./NavBar-PgYyMm5z.js";const r=document.querySelector(".center");function c(e,s){return s.topScore-e.topScore}$(document).ready(function(){$.get("https://shamem.glitch.me/get_highscores").done(function(e,s){var a=JSON.parse(e);let t=a.sort(c);o(t),d()})});function o(e){let s=e.map((a,t)=>`<article class="item">
